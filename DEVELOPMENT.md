...
> Release-prep note: confirm validation and disabled export state match the selected date-range filter.
> Release-prep note: keep mmol and converted mg/dL dose-equivalence assertions in calculator tests.
