...
> Last updated for release `v0.4.28`.
...
> Release-prep note: export validation is aligned with selected date ranges to prevent empty-range export attempts.
> Release-prep note: calculator unit tests now include mmol/mg-dL paired equivalence assertions.
